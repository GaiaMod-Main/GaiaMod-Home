...
<svelte:head>
    <title>GaiaMod - Developer Post</title>
    <meta name="title"                   content="GaiaMod - Developer Post" />
    <meta property="og:title"            content="GaiaMod - Developer Post" />
    <meta property="twitter:title"       content="GaiaMod - Developer Post" />
</svelte:head>
