...
<svelte:head>
    <title>GaiaMod - Privacy Policy</title>
    <meta name="title" content="GaiaMod - Privacy Policy" />
    <meta property="og:title" content="GaiaMod - Privacy Policy" />
    <meta property="twitter:title" content="GaiaMod - Privacy Policy">
    <meta name="description" content="The status of your privacy while using GaiaMod.">
    <meta property="twitter:description" content="The status of your privacy while using GaiaMod.">
    <meta property="og:url" content="https://gaiamod-main.github.io/GaiaMod-Home/privacy">
    <meta property="twitter:url" content="https://gaiamod-main.github.io/GaiaMod-Home/privacy">
</svelte:head>
...
<div class="main">
    ...
    <main>
        ...
        <p>
            ...
            <a href="https://gaiamod-main.github.io/GaiaMod-Home/">https://gaiamod-main.github.io/GaiaMod-Home/</a>,
        ...
        <p>
            ...
            directly access the server files for GaiaMod,
            or a person who can contact the server host that is able to access the server files and server process.
            "Host" may also refer to the server host of GaiaMod's project sharing.
        </p>
        <p>
        ...
        <p>
            GaiaMod Project Moderators and Service Administrators can identify accounts that share the same IP address as another account.
        </p>
        ...
        <p>
            When advertisements are served on any GaiaMod page, third parties may be placing and reading cookies on your browser,
            or using web beacons to collect information. Your provided birthday and country is not shared by GaiaMod to these third-parties,
            though they may obtain this information from methods or websites outside of GaiaMod's control. You may be able to
        ...
        <p>
            Content recommended to you on the GaiaMod platform is based on previous projects and content you have seen on GaiaMod before.
        ...
        <ul>
            <li>You have opened a project on GaiaMod to view it.</li>
            <li>You liked a GaiaMod project.</li>
            <li>You voted for a GaiaMod project.</li>
            <li>You interacted with a GaiaMod project.</li>
            <li>You followed another user on GaiaMod.</li>
        </ul>
        ...
        <p>When you use the <a href="https://oauth2.scratch-wiki.info/">"Scratch OAuth2"</a>,
            ...
            <ul>
                ...
                <li>your public account information on their respective platforms
                    (in some cases, emails or other information the login method provides to GaiaMod on authentication)</li>
            </ul>
        ...
        <p>
            ...
            <br>
            GaiaMod may require an email to be attached to an account for certain features or account security.
            <br>
            This will be stored on the account if provided.
        </p>
        <p>
            If you provide a date of birth or country to GaiaMod, it will be stored on your account.
            <br>
        ...
        <p>
            ...
            <a href="https://gaiamod-main.github.io/GaiaMod-Home/guidelines/uploading">Uploading Guidelines</a> have been violated.
        </p>
        ...
        <p>The purpose of this logging is for site moderators to easily find
            projects that violate the <a href="https://gaiamod-main.github.io/GaiaMod-Home/guidelines/uploading">Uploading Guidelines</a>
        ...
        <p>When an account sends a message to a moderator, receives a message from a moderator or uses language not appropriate for GaiaMod on the platform,
            account will be sent to the third-party site <a href="https://discord.com/">"Discord"</a>.
        </p>
        <p>The purpose of this logging is for site moderators to handle or respond to users that may have violated GaiaMod's
            <a href="https://gaiamod-main.github.io/GaiaMod-Home//terms">Terms of Service</a>.
        </p>
        ...
        <p>
            ...
            Requests for GaiaMod user information are expected to be sent to us using one of our contact methods.
        </p>
        ...
        <p>If a user is logged into GaiaMod, their username used by Cloud Variables, other extensions, and the editor "username" block will be set to their GaiaMod account's username.</p>
        ...
        <p>
            Built-in GaiaMod and Custom extensions that require Wi-Fi or use Wi-Fi to get online data (HTTP, Website Requests, Sound Systems, CloudLink, HTML iframes, Storage, etc.) may connect to any user-specified API, which will grant the owner of the website being connected to:
        </p>
        <ul>
            <li>your full IP address (and possibly general location using your IP address)</li>
        ...
        <p>
            The websites specified may also display any content, however GaiaMod will attempt to automatically scan the website
            for any potential viruses or vulnerabilities. Major adult websites are also blocked, and most others are blocked aswell.
        </p>
        <p>
            GaiaMod does not allow projects uploaded to only display content from other websites.
        ...
        <p>
            ...
            <p>
            The "Scratch Auth Extension" also allows your public Scratch account information to be accessible to the GaiaMod project,
     ...
     <h2>AI Extensions</h2>
            <p>In GaiaMod we have multiple AI extensions powered by diffrent technologies.
                We have extensions for chatbots like Google Gemini and OpenAI's ChatGPT. Both of these extensions were made by the <a href="https://ruby-devs.vercel.app/">Ruby Dev Team</a>, but we will most likely make changes to the extensions for
        ...
        <p>
            ...
            <p>
            The owner of GaiaAI logs and reads this information for security and preventing malicious attacks.
        </p>
        <h3>User-submitted (RubyDevs) - TurboWeather</h3>
        <p>
            TurboWeather uses Browser APIs to geolocate the user.
            <br>
            GaiaMod will ask the user to confirm this action before the extension attempts to do this.
            <br>
            <br>
