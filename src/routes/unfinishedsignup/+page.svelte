...
<svelte:head>
    <title>GaiaMod - Sign Up</title>
    <meta name="title" content="GaiaMod - Sign Up" />
    <meta property="og:title" content="GaiaMod - Sign Up" />
    <meta property="twitter:title" content="GaiaMod - Sign Up">
    <meta name="description" content="Sign up for GaiaMod to start sharing your projects!">
    <meta property="twitter:description" content="Sign up for GaiaMod to start sharing your projects!">
    <meta property="og:url" content="https://gaiamod-main.github.io/GaiaMod-Home/signup">
    <meta property="twitter:url" content="https://gaiamod-main.github.io/GaiaMod-Home/signup">
</svelte:head>
        ...
        <main>
            ...
            {#if specificFilloutForm !== "country"}
                ...
                {#if birthdayFaked}
                    <p class="birthday-warning">
                        <LocalizedText
                            text="Did your parent/guardian give you permission to use GaiaMod?"
            ...
            <label style="width:60%">
                ...
                <span class="disable-markdown-margin">
                    {@html generateMarkdown(`${TranslationHandler.textSafe(
                        ...
                        currentLang,
                        "I agree to allow GaiaMod to collect and use my country and date of birth (or my child's if I am registering on their behalf) in accordance with the [Privacy Policy](/privacy)."
                    )}`)}
                </span>
            </label>
            <label style="width:60%">
            ...
            <p>
                {@html generateMarkdown(`${TranslationHandler.textSafe(
                    ...
                    currentLang,
                    "By creating a GaiaMod account through any means provided on this page, you agree to abide by the [Terms of Service](/terms) and [Uploading Guidelines](/guidelines/uploading) and confirm that you have read the [Privacy Policy](/privacy) in its entirety. If you are a parent or guardian creating an account for a child, you agree to these terms on their behalf. If you are legally an adult, you confirm that you are creating this account for yourself."
                )}`)}
            </p>
